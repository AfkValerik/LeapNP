...
from data_structures import encode_state,encode_goal_state, extract_condition_object_pairs, get_encoded_states_with_values, extract_general_goals_pairs
from architecture import g_model_classes

class GnnGeneralGoals(NNHeuristic):
...
def gnnHeuristic(path,predicates,goal_predicates,objects,obj_encoding,num_conditions,augmented_goals_map,goals,aggregation,readout,gpus,constants):
    ...
    return GnnGeneralGoals(model, predicates, goal_predicates, objects, obj_encoding, num_conditions,augmented_goals_map,model.encoding,goals,goal_encoding,constants)
