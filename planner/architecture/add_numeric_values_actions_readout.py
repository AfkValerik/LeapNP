...
class AddNumericActionsModelValues(pl.LightningModule):
    def __init__(self, predicates: Tuple[List[Tuple[str, int,int]],int], hidden_size: int, iterations: int):
        super().__init__()
        self.save_hyperparameters()
        actions = predicates[1]
        ...
        self.readout = Readout(hidden_size, actions)
