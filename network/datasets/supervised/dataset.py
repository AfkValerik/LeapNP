...
from datasets import load_directory, load_file_spanner, get_encoded_states, get_relations
    ...
    for file in os.listdir(path):
        if '.json' in file:
            if file != domain_name + ".json":
                ...
                labeled_states.extend(get_encoded_states(instance,max_samples_per_file= max_samples_per_file))
